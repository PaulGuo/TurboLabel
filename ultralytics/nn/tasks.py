...
from ultralytics.nn.attention.CoTAttention import CoTAttention
...
from ultralytics.nn.attention.SimAMWithSlicing import SimAMWithSlicing, Conv_SWS, DSWSConv
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            c2 = ch[f[-1]]
        elif m in {CBAM, CoTAttention, SimAM, SimAMWithSlicing}:
            c1, c2 = ch[f], args[0]
            if c2 != nc:
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, *args[1:]]
